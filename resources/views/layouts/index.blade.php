...
<header class="fixed top-0 left-0 right-0 z-50">
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="h-20 flex items-center justify-between">
                ...
                <div class="hidden lg:flex items-center gap-5 text-sm">
                    ...
                    <a href="{{ route('about') }}" class="text-gray-300 hover:text-white">
                        О нас
                    </a>

                    <a href="{{ route('masters') }}" class="text-gray-300 hover:text-white">
                        Наши мастера
                    </a>

                    @auth
                        <a href="{{ route('market.index') }}" class="text-gray-300 hover:text-white">
                            Магазин
                        </a>

                        <a href="{{ route('lk') }}" class="text-gray-300 hover:text-white">
                            Личный кабинет
                        </a>

                        @if(Auth::user()->role == 'админ')
                            <a href="{{ route('requests') }}" class="text-gray-300 hover:text-white">
                                Админ
                            </a>

                            <a href="{{ route('admin.masters') }}" class="text-gray-300 hover:text-white">
                                Мастера
                            </a>

                            <a href="{{ route('add.master') }}" class="text-gray-300 hover:text-white">
                                Добавить
                            </a>
                        @endif

                        @if(Auth::user()->role == 'мастер')
                            <a href="{{ route('master.tasks') }}" class="text-gray-300 hover:text-white">
                                Задачи
                            </a>
                        @endif
                    @endauth
    ...
    <div id="mobileMenu"
        ...
        <div class="px-6 py-6 flex flex-col gap-4">
            ...
            <a href="{{ route('home') }}" class="text-white mobile-link">
                Главная
            </a>

            <a href="{{ route('about') }}" class="text-white mobile-link">
                О нас
            </a>

            <a href="{{ route('masters') }}" class="text-white mobile-link">
                Наши мастера
            </a>

            @auth

                <a href="{{ route('market.index') }}" class="text-white mobile-link">
                    Магазин
                </a>

                <a href="{{ route('lk') }}" class="text-white mobile-link">
                    Личный кабинет
                </a>

                @if(Auth::user()->role == 'админ')

                    <a href="{{ route('requests') }}" class="text-white mobile-link">
                        Админ
                    </a>

                    <a href="{{ route('admin.masters') }}" class="text-white mobile-link">
                        Мастера
                    </a>

                    <a href="{{ route('add.master') }}" class="text-white mobile-link">
                        Добавить мастера
                    </a>
                ...
                @if(Auth::user()->role == 'мастер')
                    ...
                    <a href="{{ route('master.tasks') }}" class="text-white mobile-link">
                        Задачи
                    </a>

                @endif

                @if(Auth::user()->role == 'админ' || Auth::user()->role == 'мастер')

                    <a href="{{ route('orders.index') }}" class="text-white mobile-link">
                        Заказы
                    </a>
            ...
            @guest
                ...
                <a href="{{ route('login') }}" class="text-white mobile-link">
                    Вход
                </a>

                <a href="{{ route('register') }}" class="text-white mobile-link">
                    Регистрация
                </a>
