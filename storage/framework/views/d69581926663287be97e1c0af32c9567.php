            ...
            <div class="cards d-flex flex-wrap justify-content-center mt-5 gap-3">
                <?php $__currentLoopData = $masters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $master): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="card" data-bs-theme="dark" style="width: 25rem;">
                        <img src="<?php echo e(asset('storage/' . ($master->image ?? 'uploads/masters/default.png'))); ?>" class="card-img-top" alt="...">
                        <div class="card-body">
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/polzovatel/PhpstormProjects/AutoService/resources/views/pages/masters.blade.php ENDPATH**/ ?>