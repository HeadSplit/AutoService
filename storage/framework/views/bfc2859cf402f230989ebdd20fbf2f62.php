    ...
    <section class="max-w-7xl mx-auto px-6 py-16">
        ...
        <div class="mb-12">
            ...
            <p class="text-gray-300 text-lg mt-3">
                Выберите категорию и посмотрите товары
            </p>
                ...
                <div class="bg-white/10 border border-white/10 rounded-3xl p-6 flex flex-col hover:border-amber-500 transition">
                    ...
                    <span class="px-3 py-1 rounded-full bg-white/10 text-gray-300 text-xs">
                        ...
                        <?php if(isset($category->products_count)): ?>
                            ...
                            Товаров: <?php echo e($category->products_count); ?>
...
<?php echo $__env->make('layouts.market.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/market/categories.blade.php ENDPATH**/ ?>